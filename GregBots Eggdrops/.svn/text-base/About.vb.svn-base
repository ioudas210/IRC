Public NotInheritable Class About
    ...
    Private Sub AboutBox1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.LabelVersion.Text = String.Format("Version ", My.Application.Info.Version.ToString)
        Me.LabelCopyright.Text = My.Application.Info.Copyright
        Me.LabelCompanyName.Text = "OhmSoft LLC."
        Me.TextBoxDescription.Text = "A easy to use but extremely powerful windrop"
    End Sub
